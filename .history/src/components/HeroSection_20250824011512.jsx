...
import logo from '../../src/assets/لوگو پیشتیم.svg';
import robotHandshake from '../../src/assets/robot-handshake-human-background-futuristic-digital-age.jpg';
    ...
    <header className={styles.heroSection}>
      <nav className={styles.navbar}>
        <div className={`${styles.logo} ${styles.logoContainer}`}>
          <img src={logo} alt="Pisheteam Logo" className={styles.logoImg} />
        </div>
        <button
