  ...
  return (
    <div>
      ...
      <div className={cardStyles.profileCardsRow} id="contact">
        ...
        <UserProfileCard profileImg="/photo_kia.jpg" name="Kiarsh Nadri" jobTitle="Back-End & AI Automation Engineer" bio="Designing scalable back-end systems and building intelligent automation with AI at the core." socials={socials2} minHeight={420} maxHeight={420} />
        <UserProfileCard profileImg="/photo_sina.jpg" name="Sina Alizadeh" jobTitle="Digital Marketing Specialist" bio="Focused on driving brand growth through data-driven strategies, SEO, and smart advertising. Turning analytics into action to boost engagement and reach." socials={socials3} minHeight={420} maxHeight={420} />
      </div>
      <Footer />
    </div>
  );
